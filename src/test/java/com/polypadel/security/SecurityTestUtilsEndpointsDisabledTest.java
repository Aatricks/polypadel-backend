...
@ActiveProfiles("dev")
@TestPropertySource(properties = "app.test.enabled=false")
@Import({SecurityConfig.class, SecurityTestUtilsEndpointsDisabledTest.TestBeans.class})
public class SecurityTestUtilsEndpointsDisabledTest {
    ...
    @Test
    void test_utils_is_not_allowed_when_disabled() throws Exception {
        mockMvc.perform(post("/test/users")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("{\"email\": \"e2e2@example.com\", \"password\": \"Test123!\"}"))
